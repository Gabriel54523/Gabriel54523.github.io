 // --- Cargar productos desde localStorage o usar los de ejemplo ---
...
function cargarProductos() {
  ...
  return guardados ? JSON.parse(guardados) : productosEjemplo;
}
...
// --- Usa productos desde localStorage ---
